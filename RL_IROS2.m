...
statePath = [
    imageInputLayer([numObs 1 1],'Normalization','rescale-symmetric','Name','observation')
    fullyConnectedLayer(50,'Name','CriticStateFC1')
    reluLayer('Name', 'CriticRelu1')
    fullyConnectedLayer(50,'Name','CriticStateFC2')];
actionPath = [
    imageInputLayer([numAct 1 1],'Normalization','rescale-symmetric','Name','action')
...
criticOpts = rlRepresentationOptions('LearnRate',1e-03*10, 'GradientThreshold',10); %VARIABLE LR default 0.01
