function [x, y] = SinglePosition(I, imagecentre)
    ...
    [centres,radii, metric] = imfindcircles(B, [10, 100], 'Sensitivity', 0.95); %identify circles
    ...
    if (~isempty(centres) && metric(1) > 0.1) %return circle corresponding to highest metric
        x = centres(1,1);
        y = centres(1,2);
