...
class kg_robot():
    ...
    def set_tool_digital_out(self, port, val=True):
        """ 
        dsh46 added 03/12/20: set digital tool outputs to val
        """
        prog = self.format_prog(23, acc=port, vel=val)
        return self.socket_send(prog)
